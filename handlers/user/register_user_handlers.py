from handlers.user import start, tariff_handler, get_audio, decoding_audio, support, buy_balance, promocode_menu, mail
from handlers.user.decoding_settings import choose_speakers, choose_summary, choose_words
